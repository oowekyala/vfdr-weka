...
public abstract class SufficientStats implements Serializable {
     ...
     * @param classAtt The target attribute
     * @return An array containing the probability of the example being in each
     * class
     * @throws Exception Case things turn wrong
     */
     ...
     *
     * @param inst The example with which to update.
     */
     ...
     *
     * @param expMetric The expansion metric used to evaluate antecedents
     ...
     *
     * @param i Index of the attribute to forbid
     */
    ...
    public static class NaiveBayes extends MajorityClass {
        ...
        public double[] makePrediction(Instance inst, Attribute classAtt) throws Exception {
            ...
            boolean doNB = m_nbWeightThreshold == 0 || totalWeight() > m_nbWeightThreshold;
